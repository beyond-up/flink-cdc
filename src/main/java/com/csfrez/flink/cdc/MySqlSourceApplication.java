...
import com.csfrez.flink.cdc.sink.DebugSink;
...
//            String active = parameterTool.get("ddjf.profiles.active", "");
            ...
            processSourceFunction(env, "test");
            env.execute();
        } catch (Exception e){
    ...
    private static void processSourceFunction(StreamExecutionEnvironment env, String active){
        System.out.println("processSourceFunction ====> ");
...
//            System.setProperty("HADOOP_USER_NAME", "test");
            ...
            DataStream<String> dataStream = env.addSource(sourceFunction, entry.getKey()).setParallelism(1);
            //！！！todo 转化了 结构体
            ...
            flatMapDataStream.addSink(new DebugSink(active));
        }
    }
}
